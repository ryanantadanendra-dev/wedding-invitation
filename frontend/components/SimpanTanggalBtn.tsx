...
export default function SimpanTanggalBtn(props: SimpanTanggalProps) {
  return (
    <Link
      ...
      className="w-[120px] md:w-[140px] lg:w-[120px] h-[40px] md:h-[50px] lg:h-[40px] gap-1 mt-6 flex justify-center items-center bg-accent text-background rounded-tr-[20px] rounded-bl-[20px] text-[10px] z-40"
    >
      <svg
